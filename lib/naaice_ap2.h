...
/**
 * @brief Numerical code for the function/accelerator to be used by the application
 *
 */
...
typedef struct naa_handle {
    naa_function_code_t function_code; // encodes the function to be executed on the NAA
